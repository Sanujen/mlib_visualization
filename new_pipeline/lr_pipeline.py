...
from new_pipeline.cleanser import Cleanser
from new_pipeline.encoder import Encoder
from new_pipeline.stemmer import Stemmer
...
class LRPipeline:
    ...
    def predict_for_unknown_lyrics(self, unknown_lyrics: str, model: CrossValidatorModel):
        ...
        label_to_genre = [
            ...
            # "pop", "country", "blues", "rock", "jazz", "reggae", "hip hop", "unknown",
        ]
